...
import {initFilePond} from './components/filepond';

// Expose the helper function globally so it can be called inside Blade scripts
window.initFilePond = initFilePond;

import {initFlatpickr} from './components/form-flatepicker.js';
...
class SwiperSlider {
    initSwiperSlider() {
        ...
        var swiper = new Swiper("[data-swiper='default']", {
            modules: [Autoplay], loop: true, autoplay: {
        ...
        var swiper = new Swiper("[data-swiper='navigation']", {
            modules: [Autoplay, Navigation, Pagination], loop: true, autoplay: {
                delay: 2500, disableOnInteraction: false,
            }, navigation: {
        ...
        var swiper = new Swiper("[data-swiper='dynamic']", {
            modules: [Autoplay, Pagination], loop: true, autoplay: {
                delay: 2500, disableOnInteraction: false,
            }, pagination: {
                clickable: true, el: ".swiper-pagination", dynamicBullets: true,
            },
        });

        // Pagination fraction Swiper
        var swiper = new Swiper("[data-swiper='fraction']", {
            modules: [Autoplay, Pagination, Navigation], loop: true, autoplay: {
                delay: 2500, disableOnInteraction: false,
            }, pagination: {
                clickable: true, el: ".swiper-pagination", type: 'fraction',
            }, navigation: {
                nextEl: ".swiper-button-next", prevEl: ".swiper-button-prev",
            },
        });
        ...
        var swiper = new Swiper("[data-swiper='scrollbar']", {
            modules: [Autoplay, Scrollbar, Navigation], loop: true, autoplay: {
                delay: 2500, disableOnInteraction: false,
            }, scrollbar: {
        ...
        var swiper = new Swiper("[data-swiper='vertical']", {
            modules: [Autoplay, Pagination], loop: true, direction: 'vertical', autoplay: {
                delay: 2500, disableOnInteraction: false,
            }, pagination: {
        ...
        var swiper = new Swiper("[data-swiper='effect-fade']", {
            modules: [Autoplay, Pagination, EffectFade], loop: true, effect: 'fade', autoplay: {
                delay: 2500, disableOnInteraction: false,
            }, pagination: {
                el: ".swiper-pagination", clickable: true,
            },
        ...
        var swiper = new Swiper("[data-swiper='flip']", {
            modules: [Autoplay, Pagination], loop: true, effect: 'flip', grabCursor: true, autoplay: {
                delay: 2500, disableOnInteraction: false,
            }, pagination: {
                el: ".swiper-pagination", clickable: true,
            },
        ...
        var swiper = new Swiper("[data-swiper='responsive']", {
            modules: [Pagination], loop: true, slidesPerView: 1, spaceBetween: 10, pagination: {
                el: ".swiper-pagination", clickable: true,
            }, breakpoints: {
                768: {
